...
const Banner = () => {
  ...
  return (
    <div className='flex bg-primary rounded-lg px-6 sm:px-10 md:px-14 lg:px-12 my-20 md:mx-10py-3 m-2'>
        {/* leftside */}
     ...
     {/* rightside */}
        <div className='hidden md:block md:w-1/2 lg:w-[370px] relative'>
            <img className='w-full absolute bottom-0 riight-0 max-w-md' src={assets.appointment_img} alt=""/>
        </div>
    </div>
  )
}
